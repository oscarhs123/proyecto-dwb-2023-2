...
public interface RepoProduct extends JpaRepository<Product, Integer>{
	...
	@Query(value = "SELECT * FROM product WHERE status = :status AND category_id = :category_id", nativeQuery = true)
	List<Product> listProducts(@Param("status") Integer status, @Param("category_id") Integer category_id);
	...
	Product findProductByGtin(@Param("gtin") String gtin);

	@Modifying
    @Transactional
    @Query(value = "INSERT INTO product (gtin, product, price, description, stock, category_id) VALUES(:gtin, :product, :price, :description, :stock, :category_id)", nativeQuery = true)
    void createProduct(
